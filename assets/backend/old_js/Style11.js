jQuery(document).ready(function () {
    ...
    jQuery("#heading-font-color").on("change", function () {
        jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulimate-style-" + ctuultimateid + " .vc-tabs-li span{ color:" + jQuery('#heading-font-color').val() + ";} </style>").appendTo(".ctu-ultimate-wrapper-" + ctuultimateid + "");
    });
    ...
    jQuery("#heading-icon-size").on("change", function () {
        jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulimate-style-" + ctuultimateid + " .vc-tabs-li span .oxi-icons{ font-size: " + jQuery('#heading-icon-size').val() + "px;} </style>").appendTo(".ctu-ultimate-wrapper-" + ctuultimateid + "");
    });
