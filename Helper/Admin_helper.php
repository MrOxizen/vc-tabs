...
trait Admin_helper {
        ...
        <div class="oxi-addons-wrapper">
            <div class="oxilab-new-admin-menu">
                <div class="oxi-site-logo">
                    <a href="<?php echo esc_url($this->admin_url_convert('oxi-tabs-ultimate')) ?>"
                ...
                <nav class="oxilab-sa-admin-nav">
                    ...
                    <ul class="oxilab-sa-admin-menu2">
                        ...
                        <li class="saadmin-doc">
                            <a target="_black" href="https://www.oxilabdemos.com/responsive-tabs/docs/">Docs</a>
                        </li>
                        <li class="saadmin-doc">
                            <a target="_black" href="https://wordpress.org/support/plugin/vc-tabs/">Support</a>
                        </li>
                        <li class="saadmin-set">
                            <a href="<?php echo esc_url(admin_url('admin.php?page=oxi-tabs-ultimate-settings')) ?>">
    ...
    public function Admin_Filters() {
        add_filter('vc-tabs-support-and-comments', [$this, $this->fixed_data('537570706f7274416e64436f6d6d656e7473')]);
        add_filter('oxi-tabs-plugin/pro_version', [$this, $this->fixed_data('636865636b5f63757272656e745f74616273')]);
        add_filter('oxi-tabs-plugin/admin_menu', [$this, $this->fixed_data('6f78696c61625f61646d696e5f6d656e75')]);
    }
