...
class Style6 extends Render {
    ...
    public function default_render($style, $child, $admin) {
        $content = '<div class="oxi-tabs-ultimate-style oxi-tabs-ultimate-template-6 ' . $this->headerclass . '  oxi-tab-clearfix" data-oxi-tabs=\'' . json_encode($this->attribute) . '\'>';
        /*
        ...
        foreach ($child as $key => $val) {
            ...
            $content .= '<div class="oxi-tabs-header-shape"></div>';
            $content .= '<div class="oxi-tabs-header-extend"></div>';
            $content .= '</div>';
            $number++;
        }
        $content .= '      </div> ';
