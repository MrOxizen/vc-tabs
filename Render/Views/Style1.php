...
class Style1 extends Render {
    ...
    public function default_render($style, $child, $admin) {
        ...
        $content = '<div class="oxi-tabs-ultimate-style oxi-tabs-ultimate-template-1 ' . $this->headerclass . '  oxi-tab-clearfix" data-oxi-tabs=\'' . json_encode($this->attribute) . '\'>';
        ...
        foreach ($child as $key => $val) {
            ...
            $content .= '      <div class=" oxi-tabs-body-' . $this->oxiid . ' oxi-tabs-body-tabs animate__animated ' . ($this->admin == 'admin' ? 'oxi-addons-admin-edit-list' : '') . '" id="oxi-tabs-body-' . $this->oxiid . '-' . $number . '">
