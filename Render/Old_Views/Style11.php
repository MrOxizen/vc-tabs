...
class Style11 extends Old_Render {
    ...
    public function default_render() {
        ...
        foreach ($this->child as $value) {
            ...
            $content .= ' <div class="vc-tabs-li vc-tabs-li-' . $styleid . '-id-' . $value['id'] . '" ref="#ctu-ulitate-style-' . $styleid . '-id-' . $value['id'] . '" style="color :' . $cssfile[1] . '; border-color: ' . $cssfile[1] . '">
                                <span>
        ...
        foreach ($this->child as $value) {
            $cssfile = explode('|', $value['css']);
            $titlefiles = explode('{}{}{}', $value['title']);
            $content .= '  <div class="ctu-ultimate-style-heading-' . $styleid . ' vc-tabs-li-' . $styleid . '-id-' . $value['id'] . '" ref="#ctu-ulitate-style-' . $styleid . '-id-' . $value['id'] . '" style="color :' . $cssfile[1] . '">
                        <span>
                             ' . $this->special_charecter($titlefiles[0]) . '
                        </span>
                    </div>
