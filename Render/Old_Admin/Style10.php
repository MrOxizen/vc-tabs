            ...
            <div class="oxi-addons-col-6">
                ...
                <div class="oxi-addons-content-div">
                    ...
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control oxilab-vendor-color" id="heading-font-active-color" name="heading-font-active-color" value="<?php echo esc_attr($styledata[5]); ?>" oxivalue="<?php echo esc_attr($styledata[5]); ?>">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control oxilab-vendor-color" id="heading-background-active-color" name="heading-background-active-color" value="<?php echo esc_attr($styledata[7]); ?>" oxivalue="<?php echo esc_attr($styledata[7]); ?>">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6">
                            <input class="oxi-admin-font" type="text" name="heading-font-familly" id="heading-font-familly" value="<?php echo esc_attr($styledata[9]); ?>" oxivalue="<?php echo esc_attr($styledata[9]); ?>">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                ...
                <div class="oxi-addons-content-div">
                    ...
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[19]); ?>" id="heading-number-size" name="heading-number-size">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control oxilab-vendor-color" id="heading-number-color" name="heading-number-color" value="<?php echo esc_attr($styledata[21]); ?>" oxivalue="<?php echo esc_attr($styledata[21]); ?>">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control oxilab-vendor-color" id="heading-number-active-color" name="heading-number-active-color" value="<?php echo esc_attr($styledata[15]); ?>" oxivalue="<?php echo esc_attr($styledata[15]); ?>">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control oxilab-vendor-color" id="heading-number-background-color" name="heading-number-background-color" value="<?php echo esc_attr($styledata[23]); ?>" oxivalue="<?php echo esc_attr($styledata[23]); ?>">
                        </div>
                    </div>
                </div>
            </div>
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[13]); ?>" id="heading-width" name="heading-width">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[17]); ?>" id="heading-padding" name="heading-padding">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[25]); ?>" id="heading-adsulute-width" name="heading-adsulute-width">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[27]); ?>" id="heading-adsulute-top" name="heading-adsulute-top">
                        </div>
                    </div>
                </div>
                <div class="oxi-addons-content-div">
                    ...
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-3">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[69]); ?>" id="heading-box-shadow-Horizontal" name="heading-box-shadow-Horizontal">
                        </div>
                        <div class="col-sm-3">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[71]); ?>" id="heading-box-shadow-Vertical" name="heading-box-shadow-Vertical">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-3">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[65]); ?>" id="heading-box-shadow-Blur" name="heading-box-shadow-Blur">
                        </div>
                        <div class="col-sm-3">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[73]); ?>" id="heading-box-shadow-Spread" name="heading-box-shadow-Spread">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6 ">
                            <input type="text" data-format="rgb" data-opacity="true" class="form-control oxilab-vendor-color" id="heading-box-shadow-color" name="heading-box-shadow-color" value="<?php echo esc_attr($styledata[67]); ?>" oxivalue="<?php echo esc_attr($styledata[67]); ?>">
                        </div>
                    </div>
                </div>
            ...
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[29]); ?>" id="content-font-size" name="content-font-size">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control oxilab-vendor-color" id="content-font-color" name="content-font-color" value="<?php echo esc_attr($styledata[31]); ?>" oxivalue="<?php echo esc_attr($styledata[31]); ?>">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control" type="number" step="0.1" value="<?php echo esc_attr($styledata[45]); ?>" id="content-line-height" name="content-line-height">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6">
                            <input class="oxi-admin-font" value="<?php echo esc_attr($styledata[47]); ?>" oxivalue="<?php echo esc_attr($styledata[47]); ?>" type="text" name="content-font-familly" id="content-font-familly">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
            ...
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control oxilab-vendor-color" id="content-background-color" name="content-background-color" value="<?php echo esc_attr($styledata[33]); ?>" oxivalue="<?php echo esc_attr($styledata[33]); ?>">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[35]); ?>" min="10" max="90" id="content-width" name="content-width">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-3">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[37]); ?>" id="content-padding-top" name="content-padding-top">
                        </div>
                        <div class="col-sm-3">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[41]); ?>" id="content-padding-bottom" name="content-padding-bottom">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-3">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[43]); ?>" id="content-padding-left" name="content-padding-left">
                        </div>
                        <div class="col-sm-3">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[39]); ?>" id="content-padding-right" name="content-padding-right">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                    ...
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[63]); ?>" id="content-border-radius" name="content-border-radius">
                        </div>
                    </div>
                </div>
                <div class="oxi-addons-content-div">
                    ...
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-3">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[53]); ?>" id="content-box-shadow-Blur" name="content-box-shadow-Blur">
                        </div>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6 ">
                            <input type="text" data-format="rgb" data-opacity="true" class="form-control oxilab-vendor-color" id="content-box-shadow-color" name="content-box-shadow-color" value="<?php echo esc_attr($styledata[55]); ?>" oxivalue="<?php echo esc_attr($styledata[55]); ?>">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-2">
            <div class="col-xs-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="4" id="custom-css" name="custom-css"><?php echo esc_attr($styledata[75]); ?></textarea>
        ...
        <script type="text/javascript">
            jQuery(document).ready(function () {
                jQuery("#heading-font-size").on("change", function () {
                    ...
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulimate-style-<?php echo esc_attr($styleid); ?> .vc-tabs-li em{ width:" + jQuery('#heading-font-size').val() + "px;} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulimate-style-<?php echo esc_attr($styleid); ?> .vc-tabs-li em{ height:" + jQuery('#heading-font-size').val() + "px;} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulimate-style-<?php echo esc_attr($styleid); ?> .vc-tabs-li em{ line-height:" + jQuery('#heading-font-size').val() + "px;} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                });
                ...
                jQuery("#heading-font-active-color").on("change", function () {
                    ...
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulimate-style-<?php echo esc_attr($styleid); ?> .vc-tabs-li.active em{ background-color:" + jQuery('#heading-font-active-color').val() + ";} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulimate-style-<?php echo esc_attr($styleid); ?> .vc-tabs-li.active { border-left-color: " + jQuery('#heading-font-active-color').val() + ";} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                });
                jQuery("#heading-background-active-color").on("change", function () {
                    ...
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulimate-style-<?php echo esc_attr($styleid); ?> .vc-tabs-li.active span{ background-color: " + jQuery('#heading-background-active-color').val() + ";} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                });
                ...
                jQuery("#heading-width").on("change", function () {
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulimate-style-<?php echo esc_attr($styleid); ?> .vc-tabs-li{ max-width: " + jQuery('#heading-width').val() + "px;} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                });
                jQuery("#heading-text-align").on("change", function () {
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulimate-style-<?php echo esc_attr($styleid); ?>{ justify-content: " + jQuery('#heading-text-align').val() + ";} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                });
                jQuery("#heading-padding").on("change", function () {
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?> .vc-tabs-li{ padding: " + jQuery('#heading-padding').val() + "px 10px;} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                });
                jQuery("#heading-number-size").on("change", function () {
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulimate-style-<?php echo esc_attr($styleid); ?> .vc-tabs-li em{ font-size: " + jQuery('#heading-number-size').val() + "px;} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                });
                jQuery("#heading-number-color").on("change", function () {
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulimate-style-<?php echo esc_attr($styleid); ?> .vc-tabs-li em{ color: " + jQuery('#heading-number-color').val() + ";} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                });
                jQuery("#heading-number-active-color").on("change", function () {
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulimate-style-<?php echo esc_attr($styleid); ?> .vc-tabs-li.active em{ color: " + jQuery('#heading-number-active-color').val() + ";} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                });
                jQuery("#heading-number-background-color").on("change", function () {
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulimate-style-<?php echo esc_attr($styleid); ?> .vc-tabs-li em{ background-color: " + jQuery('#heading-number-background-color').val() + ";} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                });
                jQuery("#heading-adsulute-width").on("change", function () {
                    var idva = jQuery('#heading-adsulute-width').val() / 2 + 'px';
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulimate-style-<?php echo esc_attr($styleid); ?> .vc-tabs-li.active span{ height: " + jQuery('#heading-adsulute-width').val() + "px;} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulimate-style-<?php echo esc_attr($styleid); ?> .vc-tabs-li.active span{ width: " + jQuery('#heading-adsulute-width').val() + "px;} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulimate-style-<?php echo esc_attr($styleid); ?> .vc-tabs-li.active span{ right: -" + idva + ";} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                });
                jQuery("#heading-adsulute-top").on("change", function () {
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?> .vc-tabs-li.active span{ top:" + jQuery('#heading-adsulute-top').val() + "px;} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                });
                jQuery("#heading-box-shadow-Horizontal").on("change", function () {
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulimate-style-<?php echo esc_attr($styleid); ?> .vc-tabs-li.active {box-shadow:" + jQuery('#heading-box-shadow-Horizontal').val() + "px " + jQuery('#heading-box-shadow-Vertical').val() + "px " + jQuery('#heading-box-shadow-Blur').val() + "px " + jQuery('#heading-box-shadow-Spread').val() + "px " + jQuery('#heading-box-shadow-color').val() + ";} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                });
                ...
                jQuery("#content-background-color").on("change", function () {
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulitate-style-<?php echo esc_attr($styleid); ?>-tabs{ background-color:" + jQuery('#content-background-color').val() + ";} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                });
                jQuery("#content-width").on("change", function () {
                    ...
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ultimate-style-<?php echo esc_attr($styleid); ?>-content{ width: calc(" + jQuery('#content-width').val() + "% -  " + idval + ");} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                    jQuery("<style type='text/css'>#oxi-addons-preview-data   .ctu-ulimate-style-<?php echo esc_attr($styleid); ?>{ width: calc( " + idhead + " + " + idval + " );} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                });
                ...
                jQuery("#content-font-align").on("change", function () {
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulitate-style-<?php echo esc_attr($styleid); ?>-tabs{ text-align:" + jQuery('#content-font-align').val() + ";} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                });
                jQuery("#content-border-radius").on("change", function () {
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulitate-style-<?php echo esc_attr($styleid); ?>-tabs{ border-radius:" + jQuery('#content-border-radius').val() + "px;} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                });
                jQuery("#content-box-shadow-Blur").on("change", function () {
                    ...
                    jQuery("<style type='text/css'>#oxi-addons-preview-data   .ctu-ulitate-style-<?php echo esc_attr($styleid); ?>-tabs {box-shadow :" + idvalue + ";} </style>").appendTo(" .ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                });
                ...
                jQuery("#content-box-shadow-color").on("change", function () {
                    jQuery("<style type='text/css'>#oxi-addons-preview-data   .ctu-ulitate-style-<?php echo esc_attr($styleid); ?>-tabs{box-shadow:" + jQuery('#content-box-shadow-Horizontal').val() + "px " + jQuery('#content-box-shadow-Vertical').val() + "px " + jQuery('#content-box-shadow-Blur').val() + "px " + jQuery('#content-box-shadow-Spread').val() + "px " + jQuery('#content-box-shadow-color').val() + ";} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                });
            });
        </script>
        <?php
