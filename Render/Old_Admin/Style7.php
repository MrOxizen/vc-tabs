            ...
            <div class="oxi-addons-col-6">
                ...
                <div class="oxi-addons-content-div">
                    ...
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6 ">
                            <input type="text" class="form-control oxilab-vendor-color" id="heading-border-color" name="heading-border-color" value="<?php echo esc_attr($styledata[11]); ?>" oxivalue="<?php echo esc_attr($styledata[11]); ?>">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
            ...
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6 ">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[21]); ?>" id="heading-padding" name="heading-padding">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6 ">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[59]); ?>" id="content-border-radius" name="content-border-radius">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6 ">
                            <input type="text" class="form-control oxilab-vendor-color" id="content-font-color" name="content-font-color" value="<?php echo esc_attr($styledata[25]); ?>" oxivalue="<?php echo esc_attr($styledata[25]); ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6 ">
                            <input type="text" data-format="rgb" data-opacity="true" class="form-control oxilab-vendor-color" id="content-background-color" name="content-background-color" value="<?php echo esc_attr($styledata[27]); ?>" oxivalue="<?php echo esc_attr($styledata[27]); ?>">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6 ">
                            <input type="text" data-format="rgb" data-opacity="true" class="form-control oxilab-vendor-color" id="content-border-color" name="content-border-color" value="<?php echo esc_attr($styledata[45]); ?>" oxivalue="<?php echo esc_attr($styledata[45]); ?>">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control" type="number" step="0.1" value="<?php echo esc_attr($styledata[37]); ?>" id="content-line-height" name="content-line-height">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6 ">
                            <input class="oxi-admin-font" value="<?php echo esc_attr($styledata[39]); ?>" oxivalue="<?php echo esc_attr($styledata[39]); ?>" type="text" name="content-font-familly" id="content-font-familly">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
            ...
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-3">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[29]); ?>" id="content-padding-top" name="content-padding-top">
                        </div>
                        <div class="col-sm-3">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[33]); ?>" id="content-padding-bottom" name="content-padding-bottom">
                        </div>
                    ...
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-3">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[31]); ?>" id="content-padding-right" name="content-padding-right">
                        </div>
                        <div class="col-sm-3">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[35]); ?>" id="content-padding-left" name="content-padding-left">
                        </div>
                    </div>
                ...
                <div class="oxi-addons-content-div">
                    ...
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-3">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[51]); ?>" id="content-box-shadow-Horizontal" name="content-box-shadow-Horizontal">
                        </div>
                        <div class="col-sm-3">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[53]); ?>" id="content-box-shadow-Vertical" name="content-box-shadow-Vertical">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-3">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[47]); ?>" id="content-box-shadow-Blur" name="content-box-shadow-Blur">
                        </div>
                        <div class="col-sm-3">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[55]); ?>" id="content-box-shadow-Spread" name="content-box-shadow-Spread">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6 ">
                            <input type="text" data-format="rgb" data-opacity="true" class="form-control oxilab-vendor-color" id="content-box-shadow-color" name="content-box-shadow-color" value="<?php echo esc_attr($styledata[49]); ?>" oxivalue="<?php echo esc_attr($styledata[49]); ?>">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script type="text/javascript">
            jQuery(document).ready(function () {
                ...
                jQuery("#content-border-color").on("change", function () {
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>{ border-color:" + jQuery('#content-border-color').val() + ";} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                });
                jQuery("#content-border-radius").on("change", function () {
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>{ border-radius:" + jQuery('#content-border-radius').val() + "px " + jQuery('#content-border-radius').val() + "px 0 0 ;} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                });
