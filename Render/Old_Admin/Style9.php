            ...
            <div class="oxi-addons-col-6">
                ...
                <div class="oxi-addons-content-div">
                    ...
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6 ">
                            <input type="text" class="form-control oxilab-vendor-color" id="heading-font-border-color" name="heading-font-border-color" value="<?php echo esc_attr($styledata[9]); ?>" oxivalue="<?php echo esc_attr($styledata[9]); ?>">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
            ...
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6 ">
                            <input type="number" class="form-control" min='0' id="heading-border-radius" name="heading-border-radius" value="<?php echo esc_attr($styledata[27]); ?>">
                        </div>
                    </div>
                </div>
                <div class="oxi-addons-content-div">
                    ...
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-3">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[61]); ?>" id="heading-box-shadow-Horizontal" name="heading-box-shadow-Horizontal">
                        </div>
                        <div class="col-sm-3">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[63]); ?>" id="heading-box-shadow-Vertical" name="heading-box-shadow-Vertical">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-3">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[65]); ?>" id="heading-box-shadow-Spread" name="heading-box-shadow-Spread">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
            ...
            <div class="oxi-addons-col-6">
                ...
                <div class="oxi-addons-content-div">
                    ...
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-3">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[55]); ?>" id="content-box-shadow-Horizontal" name="content-box-shadow-Horizontal">
                        </div>
                        <div class="col-sm-3">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[57]); ?>" id="content-box-shadow-Vertical" name="content-box-shadow-Vertical">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-3">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[59]); ?>" id="content-box-shadow-Spread" name="content-box-shadow-Spread">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
        ...
        <script type="text/javascript">
            jQuery(document).ready(function () {
                ...
                jQuery("#heading-background-color").on("change", function () {
                    ...
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulimate-style-<?php echo esc_attr($styleid); ?> .vc-tabs-li.active .ctu-absolute{ border-top-color: " + jQuery('#heading-background-color').val() + ";} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                });
                ...
                jQuery("#heading-font-border-color").on("change", function () {
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulimate-style-<?php echo esc_attr($styleid); ?> .vc-tabs-li{ border-color: " + jQuery('#heading-font-border-color').val() + ";} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                });
                ...
                jQuery("#heading-padding").on("change", function () {
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulimate-style-<?php echo esc_attr($styleid); ?> .vc-tabs-li{ margin: " + jQuery('#heading-padding').val() + "px 0;} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulimate-style-<?php echo esc_attr($styleid); ?> .vc-tabs-li.active .ctu-absolute{ bottom: calc(-10px - " + jQuery('#heading-padding').val() + "px);} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                });
                ...
                jQuery("#heading-box-shadow-Horizontal").on("change", function () {
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulimate-style-<?php echo esc_attr($styleid); ?> {box-shadow:" + jQuery('#heading-box-shadow-Horizontal').val() + "px " + jQuery('#heading-box-shadow-Vertical').val() + "px " + jQuery('#heading-box-shadow-Blur').val() + "px " + jQuery('#heading-box-shadow-Spread').val() + "px " + jQuery('#heading-box-shadow-color').val() + ";} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                });
                ...
                jQuery("#heading-border-radius").on("change", function () {
                    ...
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulitate-style-<?php echo esc_attr($styleid); ?>-tabs {border-radius:0 0 " + jQuery("#heading-border-radius").val() + "px " + jQuery("#heading-border-radius").val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
                ...
                jQuery("#content-font-weight").on("change", function () {
                    ...
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulitate-style-<?php echo esc_attr($styleid); ?>-tabs p{ font-weight:" + idvalue + ";} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                });
