            ...
            <div class="oxi-addons-col-6">
                ...
                <div class="oxi-addons-content-div">
                    ...
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6 ">
                            <input type="text" data-format="rgb" data-opacity="true" class="form-control oxilab-vendor-color" id="heading-background-active-color" name="heading-background-active-color" value="<?php echo esc_attr($styledata[11]); ?>" oxivalue="<?php echo esc_attr($styledata[11]); ?>">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6 ">
                            <input type="text" class="form-control oxilab-vendor-color" id="heading-border-active-color" name="heading-border-active-color" value="<?php echo esc_attr($styledata[13]); ?>" oxivalue="<?php echo esc_attr($styledata[13]); ?>">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6 ">
                            <input class="oxi-admin-font" type="text" name="heading-font-familly" id="heading-font-familly" value="<?php echo esc_attr($styledata[15]); ?>" oxivalue="<?php echo esc_attr($styledata[15]); ?>">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
            ...
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6 ">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[21]); ?>" id="heading-width" name="heading-width">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6 ">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[23]); ?>" id="heading-padding" name="heading-padding">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6 ">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[55]); ?>" id="heading-margin-right" name="heading-margin-right">
                        </div>
                    </div>
                </div>
                <div class="oxi-addons-content-div">
                    ...
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-3">
                            <input class="form-control" type="number" value="<?php echo esc_attr($styledata[25]); ?>" id="heading-box-shadow-Blur" name="heading-box-shadow-Blur">
                        </div>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6 ">
                            <input type="text" data-format="rgb" data-opacity="true" class="form-control oxilab-vendor-color" id="heading-box-shadow-color" name="heading-box-shadow-color" value="<?php echo esc_attr($styledata[27]); ?>" oxivalue="<?php echo esc_attr($styledata[27]); ?>">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6 ">
                            <input type="text" data-format="rgb" data-opacity="true" class="form-control oxilab-vendor-color" id="content-background-color" name="content-background-color" value="<?php echo esc_attr($styledata[33]); ?>" oxivalue="<?php echo esc_attr($styledata[33]); ?>">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
                ...
                <div class="oxi-addons-content-div">
                    ...
                    <div class="form-group row form-group-sm">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control oxilab-vendor-color" id="content-box-shadow-color" name="content-box-shadow-color" value="<?php echo esc_attr($styledata[51]); ?>" oxivalue="<?php echo esc_attr($styledata[51]); ?>">
                        </div>
                    </div>
                    <div class="form-group row form-group-sm">
        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-2">
            <div class="col-xs-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="4" id="custom-css" name="custom-css"><?php echo esc_attr($styledata[71]); ?></textarea>
        ...
        <script type="text/javascript">
            jQuery(document).ready(function () {
                ...
                jQuery("#heading-border-color").on("change", function () {
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulimate-style-<?php echo esc_attr($styleid); ?> .vc-tabs-li{border-color: " + jQuery("#heading-border-color").val() + "; } </style>").appendTo("#oxi-addons-preview-data");
                });
                ...
                jQuery("#heading-border-active-color").on("change", function () {
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulimate-style-<?php echo esc_attr($styleid); ?> .vc-tabs-li.active{border-color: " + jQuery("#heading-border-active-color").val() + "; } </style>").appendTo("#oxi-addons-preview-data");
                });
                jQuery('#heading-font-familly').change(function () {
                    ...
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ultimate-style-heading-<?php echo esc_attr($styleid); ?>{ font-family:" + font[0] + ";} </style>").appendTo(".oxi-addons-preview-data");
                });
                ...
                jQuery("#heading-font-style").on("change", function () {
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulimate-style-<?php echo esc_attr($styleid); ?> .vc-tabs-li{ font-style: " + jQuery(this).val() + ";} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>");
                });
                ...
                jQuery("#heading-margin-right").on("change", function () {
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulimate-style-<?php echo esc_attr($styleid); ?> .vc-tabs-li{margin: 0 " + jQuery("#heading-margin-right").val() + "px 0 0; } </style>").appendTo("#oxi-addons-preview-data");
                });
                jQuery("#heading-box-shadow-Horizontal").on("change", function () {
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ultimate-wrapper-<?php echo esc_attr($styleid); ?>{box-shadow: " + jQuery("#heading-box-shadow-Horizontal").val() + "px " + jQuery("#heading-box-shadow-Vertical").val() + "px " + jQuery("#heading-box-shadow-Blur").val() + "px " + jQuery("#heading-box-shadow-Spread").val() + "px " + jQuery("#heading-box-shadow-color").val() + ";} </style>").appendTo("#oxi-addons-preview-data");
                });
                ...
                jQuery('#content-font-familly').change(function () {
                    var font = jQuery(this).val().replace(/\+/g, ' ');
                    font = font.split(':');
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulitate-style-<?php echo esc_attr($styleid); ?>-tabs{ font-family:" + font[0] + ";} </style>").appendTo(".oxi-addons-preview-data");
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulitate-style-<?php echo esc_attr($styleid); ?>-tabs p{ font-family:" + font[0] + ";} </style>").appendTo(".oxi-addons-preview-data");
                });
                ...
                jQuery("#content-box-shadow-Horizontal").on("change", function () {
                    jQuery("<style type='text/css'>#oxi-addons-preview-data  .ctu-ulitate-style-<?php echo esc_attr($styleid); ?>-tabs{box-shadow: " + jQuery("#content-box-shadow-Horizontal").val() + "px " + jQuery("#content-box-shadow-Vertical").val() + "px " + jQuery("#content-box-shadow-Blur").val() + "px " + jQuery("#content-box-shadow-Spread").val() + "px " + jQuery("#content-box-shadow-color").val() + ";} </style>").appendTo("#oxi-addons-preview-data");
                });
