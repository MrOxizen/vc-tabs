...
class Settings {
    ...
    public function Render() {
                ...
                <form method="post">
                    ...
                    <table class="form-table" role="presentation">
                        <tbody>
                            <tr>
                                <th scope="row">
                                    <label for="oxi_vc_tabs_permission">Who Can Edit?</label>
                                </th>
                                <td>
                                    <fieldset>
        ...
        <?php foreach ($this->roles as $key => $role) { ?>
                                        ...
                                        <span class="oxi-addons-settings-connfirmation oxi_vc_tabs_permission"></span>
                                        <br>
                                ...
                                <td>
                                    <fieldset>
                                        <label for="oxi_addons_font_awesome[yes]">
                                            <input type="radio" class="radio" id="oxi_addons_font_awesome[]"
                                                   name="oxi_addons_font_awesome"
                                                   value="" <?php checked('', get_option('oxi_addons_font_awesome'), true); ?>>
                                            Yes</label>
                                        <label for="oxi_addons_font_awesome[no]">
                                            <input type="radio" class="radio" id="oxi_addons_font_awesome[no]"
                                                   name="oxi_addons_font_awesome"
                                                   value="no" <?php checked('no', get_option('oxi_addons_font_awesome'), true); ?>>
                                            No
                                        </label>
                            ...
                            <tr>
                                ...
                                <td class="valid">
                                    <input type="text" class="regular-text" id="oxi_addons_fixed_header_size"
                                           name="oxi_addons_fixed_header_size"
                                           value="<?php echo esc_attr($this->oxi_fixed_header); ?>">
                                ...
                                <td>
                                    <fieldset>
                                        <label for="oxi_tabs_support_massage[yes]">
                                            <input type="radio" class="radio" id="oxi_tabs_support_massage[yes]"
                                                   name="oxi_tabs_support_massage"
                                                   value="" <?php checked('', get_option('oxi_tabs_support_massage'), true); ?>>
                                            Yes</label>
                                        <label for="oxi_tabs_support_massage[no]">
                                            <input type="radio" class="radio" id="oxi_tabs_support_massage[no]"
                                                   name="oxi_tabs_support_massage"
                                                   value="no" <?php checked('no', get_option('oxi_tabs_support_massage'), true); ?>>
                                            No
                                        </label>
                            ...
                            <tr>
                                ...
                                <td class="valid">
                                    <input type="text" class="regular-text"
                                           id="responsive_tabs_with_accordions_license_key"
